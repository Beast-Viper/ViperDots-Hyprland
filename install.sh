...
DIRS=("avizo" "btop" "conky" "easyeffects" "eww" "fastfetch" "fish" "gtk-3.0" "gtk-4.0" "hypr" "hyprlauncher" "kitty" "nvim" "swaync" "waybar" "wlogout")
...
stow --target=$HOME/.local/share/ bin
